        ...
        <View style={styles.container}>
          <View style={styles.header}>
            ...
            <SafeAreaView style={styles.addRoute}>
                ...
                <TextInput style={styles.input} placeholder="Drop Off City"/>
                <Text style={styles.inputLabel}>To</Text>
                <TextInput style={styles.input} placeholder="Destination City"/>
            ...
            <SafeAreaView style={styles.addAddress}>
              <View style={{flex: 2}}>
                ...
                <TextInput style={styles.input} placeholder="Location To Drop-Off Package"/>
                <TextInput style={styles.input} placeholder="2nd Address Line ( Optional )"/>
              </View>
              <View style={{flex: 2}}>
                <Text style={styles.inputLabel}>Pick-Up Address</Text>
                <TextInput style={styles.input} placeholder="Location To Pick-Up Package"/>
                <TextInput style={styles.input} placeholder="2nd Address Line ( Optional )"/>
              </View>
              <View style={{flex: 2}}>
                <Text style={styles.inputLabel}>Facility Information</Text>
                <TextInput style={styles.input} placeholder="Describe The Annoucements" multiline={true}
    numberOfLines={3}/>
              </View>
          </SafeAreaView>
